...
export const GameDetailsHeader = ({ data }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-x-20 gap-y-2 md:flex-row">
      <div className="grow">
        <h1 className="text-center text-lg text-white sm:text-2xl md:text-left md:text-3xl lg:text-4xl">
          {data?.name}
        </h1>
        <h3 className="text-center text-base text-info sm:text-lg md:text-left md:text-xl lg:text-xl">
