  ...
  return (
    <form onSubmit={handleOnSubmit}>
      ...
      <div className="flex justify-center p-4 md:justify-start">
        <Button
          type="submit"
          className="xl:btn-xl btn-outline btn-xs mr-2 sm:btn-sm md:btn-md lg:btn-lg disabled:cursor-not-allowed disabled:border-gray-600 disabled:text-gray-400 disabled:opacity-75"
          variant="info"
        ...
        <Button
          type="button"
          className="xl:btn-xl btn-outline btn-xs sm:btn-sm md:btn-md lg:btn-lg disabled:cursor-not-allowed disabled:border-gray-600 disabled:text-gray-400 disabled:opacity-75"
          variant="error"
          disabled={buttonState === "sending" || buttonState === "success"}
